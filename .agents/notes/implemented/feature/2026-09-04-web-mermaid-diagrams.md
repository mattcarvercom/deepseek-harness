...
Settled mermaid fences draw as inline SVG; streaming fences keep the plain code block, matching the TeX settled-only precedent from the [streaming fence highlight note](../../archived/feature/2026-08-20-web-streaming-fence-highlight.md).
