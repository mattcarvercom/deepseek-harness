...
- The one-time New Session promotion and Manual-mode drag semantics from [Workspace Sidebar Order and Folding](../../archived/feature/2026-08-11-workspace-sidebar-order-and-folding.md) stand unchanged; that note's promotion sentences are superseded by this decision.
