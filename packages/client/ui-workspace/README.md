...
- **Session deletion is the only irreversible action** — archived sessions are restored from the archived-sessions Settings page ([ui-settings-unarchive-sessions](../ui-settings-unarchive-sessions/README.md)); deleting a Session destroys its stored log and cannot be undone, and deleting a Workspace registration only ungroups its Sessions, whose logs stay in place.
