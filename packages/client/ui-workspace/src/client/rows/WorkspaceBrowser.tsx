...
function SessionTree({
  ...
  const groups = useMemo(
    ...
    [list, workspaces, archivedSessionIds, statuses, expandedGroups, ungroupedSessionIds, showArchived],
  )
  useEffect(() => {
...
> & {
  ...
  const statuses = useSessionStatus(s => s)
  const rows = useMemo(
    () => deriveFlat(list, sessionIds, statuses, archivedSessionIds),
    [list, sessionIds, statuses, archivedSessionIds],
  )
  const [drag, setDrag] = useState<DragState | null>(null)
