...
export const zh = {
  ...
  'deleteSession.desc': '将永久删除会话“{name}”：会话记录及其全部内容将被销毁。此操作不可恢复。',
  'deleteSession.confirm': '删除会话',
...
export const en = {
  ...
  'archived.show': 'Show archived sessions',
  ...
  'deleteSession.desc': 'This permanently deletes the session “{name}”: its log and all of its content are destroyed. This cannot be undone.',
  'deleteSession.confirm': 'Delete session',
