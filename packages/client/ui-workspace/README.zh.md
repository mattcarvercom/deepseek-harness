...
- **删除 Session 是唯一不可逆操作**：已归档会话从「已归档会话」设置页（[ui-settings-unarchive-sessions](../ui-settings-unarchive-sessions/README.zh.md)）恢复；删除 Session 会销毁其存储日志且无法撤销，而删除 Workspace 注册只会让其 Session 变为 Ungrouped，日志原样保留。
