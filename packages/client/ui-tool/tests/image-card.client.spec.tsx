...
describe('ReadImageRow keyed toolview', () => {
  ...
  const rowProps = (
    ...
    callId: 'c1', toolName: 'read_image', block, openFile: vi.fn(), renderImages, loadImage: loader,
...
describe('genericImageCardModel', () => {
  ...
  it('declines running calls, error results, and malformed call heads', () => {
    ...
    expect(genericImageCardModel(genericSettled({ call: { name: '', argsRaw: '{}' } } as never))).toBeNull()
...
describe('GenericToolCard image results', () => {
  ...
  const cardProps = (
    ...
    callId: 'c9', toolName: 'mcp__sd__txt2img', block: genericSettled(), openFile: vi.fn(),
