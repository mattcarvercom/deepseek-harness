...
export const zh = {
  ...
  'tool.activity.output': '输出中',
  'tool.activity.tool': '执行工具中',
  'tool.activity.other': '工作中',
...
export const en = {
  ...
  'tool.activity.output': 'Producing output',
  'tool.activity.tool': 'Running a tool',
  'tool.activity.other': 'Working',
