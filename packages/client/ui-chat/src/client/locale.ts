...
export const zh = {
  ...
  'chat.pendingQueued': '排队中',
  'chat.pendingSteering': '引导中',
  ...
  'chat.pill.waitingFirstToken': '等待首个 token…',
  'chat.pill.thinking': '思考中…',
  'chat.pill.generating': '生成中…',
  'chat.pill.runningTool': '正在运行 {tool}',
  'chat.pill.waitingChild': '等待子代理 {label}',
  'chat.pill.retrying': '正在重试 {retry}/{max} · {in} · {failure}',
  'chat.pill.retryingNoMax': '正在重试 {retry} · {in} · {failure}',
  'chat.pill.waitingJob': '等待后台任务 {label}',
  'chat.pill.working': '工作中…',
  'chat.action.cancelRerun': '取消并重试',
  'chat.action.showLog': '查看日志',
  'chat.action.killChild': '终止子代理',
  'chat.rerunConfirm.title': '取消并重试？',
  'chat.rerunConfirm.body': '本轮将停止，其原始提示词会作为新轮次重新发送。本轮已产生的内容会保留在对话中。',
  'chat.rerunConfirm.keep': '继续运行',
...
export const en = {
  ...
  'chat.pendingQueued': 'Queued',
  'chat.pendingSteering': 'Steering',
  ...
  'chat.pill.waitingFirstToken': 'Waiting for first token…',
  'chat.pill.thinking': 'Thinking…',
  'chat.pill.generating': 'Generating…',
  'chat.pill.runningTool': 'Running {tool}',
  'chat.pill.waitingChild': 'Waiting on child {label}',
  'chat.pill.retrying': 'Retrying {retry}/{max} · {in} · {failure}',
  'chat.pill.retryingNoMax': 'Retrying {retry} · {in} · {failure}',
  'chat.pill.waitingJob': 'Waiting for job {label}',
  'chat.pill.working': 'Working…',
  'chat.action.cancelRerun': 'Cancel & re-run',
  'chat.action.showLog': 'Show log',
  'chat.action.killChild': 'Kill child',
  'chat.rerunConfirm.title': 'Cancel & re-run?',
  'chat.rerunConfirm.body': 'This turn will stop and its original prompt will be sent again as a new turn. Everything this turn has produced so far stays in the conversation.',
  'chat.rerunConfirm.keep': 'Keep running',
